    ...
    private void resLabel(int result, double weight){
        ...
        if (result == 0) {
            textArea.append("Your cat's weight is absolutely normal. \n " +
                    ...
                    "\n if you feed your cat with natural food, it's recommended to give your cat "
                    + String.format("%.2f", weight * 50 / 2) +
                    " grams of meat per day and " + String.format("%.2f", weight * 50 / 2) +
                    " grams of fermented milk products. Also add 10-15 grams of vegetables per day;");
        }
        if (result == 1) {
            textArea.append("Your cat is overweight. \n " +
                    ...
                    "\n- if you feed your cat with natural food, it's recommended to give your cat "
                    + String.format("%.2f",weight*45/2)+
                    " grams of meat per day and " + String.format("%.2f",weight*45/2) +
                    " grams of fermented milk products. Also add 10-15 grams of vegetables per day;\n" +
        ...
        if (result == 2) {
            textArea.append("Your cat is underweight. \n " +
                    "You should give more attention to the diet of your cat. Here are some recommendations:\n" +
                    "\n- buy cat food for cats with a lack of weight and feed your cat according " +
                    "to the instructions written on the package;\n" +
                    "\n- if you feed your cat with natural food, it's recommended to give your cat " + String.format("%.2f",weight*60/2)+
                    " grams of meat per day and " + String.format("%.2f",weight*60/2) +
                    " grams of fermented milk products. Also add 10-15 grams of vegetables per day;\n" +
